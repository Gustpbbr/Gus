---
tipo: documentacao-historica
projeto: gus
arquivado_em: 2026-05-02
arquivado_por: claude-code
substituido_por: projetos/gus/gus-26-status-consolidado.md
---

> **⚠️ ARQUIVO HISTÓRICO — não é o plano atual.**
>
> Este foi o plano de 24/04/2026. Quase todos os itens A-H já foram
> implementados (rate limiting, backup JSON, briefing matinal,
> retrospectiva semanal, comando `/custo`, fila de ações).
>
> O plano corrente está em `projetos/gus/gus-26-status-consolidado.md`
> e o handoff vivo em `projetos/gus/_estado-atual.md`.
>
> Mantido aqui pra arqueologia/contexto histórico.

---

# Gus — Plano dos próximos passos (Níveis 2 e 3, execução local) [HISTÓRICO]
