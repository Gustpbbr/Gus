...
prioridade: media
status: pendente
criado_em: 2026-05-02T22:45:00-03:00
processado_em: ""
processado_por: ""
acao_sugerida: criar_novo
destino_path: ""
contexto: "v2 da demanda de ingestão de exames como fragmentos. Substitui a v1 (criada às 22:30) — adiciona nota sobre TioGu poder usar Sonnet 4.6 ou GPT-4o conforme conveniência."
---

# Ingestão de exames laboratoriais como fragmentos no Hub Qdrant — v2

> ⚠️ **Esta demanda substitui a v1** criada em `2026-05-02T22-30__ingestao-exames-fragmentos-hub.md`. A v1 pode ser arquivada/descartada.
...
## Modelo de IA para execução

A geração dos textos `texto_para_embedding` dos fragmentos pode ser feita com **Sonnet 4.6 ou GPT-4o**, conforme o que TioGu julgar mais adequado por custo/qualidade. Especificação é modelo-agnóstica. Registrar no campo `metadata.modelo_ia` qual modelo foi efetivamente usado em cada fragmento gerado.
...
```json
{
  ...
  "metadata": {
    ...
    "modelo_ia": "string (claude-sonnet-4-6 | gpt-4o | claude-opus-4-7 | etc)",
...
5. Notificação Telegram quando o backfill concluir, com resumo: total de fragmentos gerados, modelo IA usado, custo aproximado.
...
- **Modelo IA flexível:** Sonnet 4.6 ou GPT-4o, à critério de TioGu por custo/qualidade. Registrar qual foi usado.
...
-- Claude Chat | via=claude-chat | 02/05/2026 (v2)
