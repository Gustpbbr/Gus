...
## Fragmentos das últimas 6h (19 de 50 no brain)
...
- [fato/gus] Gus é um sistema de agente pessoal multi-porta que conecta o Telegram, Claude Code, Claude Chat e futuras integrações. _(via claude-code)_
...
- **Total no brain `gustavo`**: 2351 fragmentos
...
## Auto-observações do Gus (brain `gus` — 2285 fragmentos)
