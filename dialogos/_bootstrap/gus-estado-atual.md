...
- [fato/gus] O estado da coleção gus no Qdrant é vazio e o Mem0 SaaS está dormente na pasta histórico. _(via claude-code)_
...
- [fato/gus] A coleção legada `gus` na Qdrant está vazia e não possui fragmentos históricos. _(via claude-code)_
...
- [fato/projetos] A stack está em estado intermediário arriscado: Hub Qdrant (`gus_hub`) é a fonte nova, mas a coleção legada `gus` (Mem0 self-hosted) tem ~204 fragmentos não-migrados e o código de leitura em `gus/m... _(via claude-code)_
...
- [decisao/projetos] A demanda `2026-05-01-captura-multiporta-curador.md` precisa de um gatilho proativo no Chat. _(via claude-code)_
- [cronologico/gus] A migração para o Hub Qdrant está em curso e deve ser concluída até 12/05/2026. _(via claude-code)_
- [fato/gus] Fragmentos são processados por um curador, mas o sistema não diferencia entre informações extraídas relacionadas ao Gustavo e suas auto-observações como Gus. _(via claude-code)_
- [fato/projetos] Há 6 demandas pendentes em `dialogos/inbox-claude-code/`. _(via claude-code)_
- [identidade_operacional/projetos] Estou na branch `claude/initial-setup-iWTfL`. _(via claude-code)_
- [procedural/projetos] Aguarda redeploy (~2 min). _(via claude-code)_

## Resumo numérico

- **Total no brain `gustavo`**: 926 fragmentos
...
- `episodico`: 2
- `rotina`: 1
- `identidade_operacional`: 1
- `lacuna`: 1
- `biografico`: 1
- `projeto`: 1
- `cronologico`: 1

## Auto-observações do Gus (brain `gus` — 876 fragmentos)
...
- [fato/gus] Existem 204 fragmentos no Mem0 SaaS que foram exportados para a pasta historico. _(via claude-code)_
- [fato/projetos] Os 4 documentos principais que trazem 80% do contexto são: dialogos/_bootstrap/gus-bootstrap.md, dialogos/_bootstrap/gus-identity.md, dialogos/_bootstrap/gus-estado-atual.md e projetos/gus/_estado-... _(via claude-code)_
