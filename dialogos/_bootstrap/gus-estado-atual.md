...
- [fato/projetos] O projeto `inbox-mem0-from-chat/` é um legado, já que o Mem0 SaaS está aposentado. O nome foi herdado e agora precisa ser renomeado para `inbox-chat-raw/`. _(via claude-code)_
...
- **Total no brain `gustavo`**: 2020 fragmentos
...
## Auto-observações do Gus (brain `gus` — 1954 fragmentos)
